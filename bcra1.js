...
function checkBiopsy() {
  if (document.risk.ever_had_biopsy.selectedIndex==1) { // Unknown
    document.risk.previous_biopsies.options.length = 1;
    document.risk.previous_biopsies.options[1] = new Option("n/a");
    document.risk.previous_biopsies.selectedIndex = 0;
    document.risk.previous_biopsies.options[1].value = 99;

    document.risk.biopsy_with_hyperplasia.options.length = 1;
    document.risk.biopsy_with_hyperplasia.options[1] = new Option("n/a");
  ...
  if (document.risk.ever_had_biopsy.selectedIndex==2) { // No
    ...
    document.risk.previous_biopsies.options[1] = new Option("n/a");
    document.risk.previous_biopsies.selectedIndex = 0;
    document.risk.previous_biopsies.options[1].value = 0;
    document.risk.biopsy_with_hyperplasia.options.length = 1;
    document.risk.biopsy_with_hyperplasia.options[1] = new Option("n/a");
    document.risk.biopsy_with_hyperplasia.selectedIndex = 0;
    document.risk.biopsy_with_hyperplasia.options[1].value = 0;
  }
...
function calculate() {
var raceval = document.getElementById("race");
var selectedrace = raceval.options[raceval.selectedIndex].text;
//alert(selectedrace);
var subraceval = document.getElementById("subrace");
var selectedsubrace = subraceval.options[subraceval.selectedIndex].text;
//alert(selectedsubrace);
  ...
  userid=document.risk.useridbox.value;
  if (document.risk.race.selectedIndex == 4) {
...
window.location='assesmentresult.html?&abs1='+abs1+'&avr1='+avr1+'&abs2='+abs2+'&avr2='+avr2+'&age='+age+'&minus1='+minus1+'&race='+selectedrace+'&subrace='+selectedsubrace;
});
  return;
